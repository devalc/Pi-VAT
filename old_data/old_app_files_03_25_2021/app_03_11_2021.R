                        ...
                        pickerInput(
                            ...
                            choicesOpt = list(
                                content = stringr::str_trunc(c("Runoff (mm)",
                                                               ...
                                                               "Soluble reactive phosphorus (kg/ha)",
                                                               "Particulate phosphorus (kg/ha)",
                                                               "Total phoshorus (kg/ha)",
                                                               "Particle Class 1 Fraction (kg/ha)",
                                                               "Particle Class 2 Fraction (kg/ha)"  ,
                                                               "Particle Class 3 Fraction (kg/ha)" ,
                                                               "Particle Class 4 Fraction (kg/ha)" ,
                                                               "Particle Class 5 Fraction (kg/ha)" ,
                                                               "Particle Fraction.Under.0.016.mm (kg/ha)"  ,
        ...
        if (input$AreaVsScen == 'allscen') {
            ...
            if (input$AreaVsScen == 'allwat') {
                if (input$ScenVvar == "Heatmap") {
                    d <-
                        Wshed_subset() %>% 
                        dplyr::select(Watershed, input$wshed_var) %>% 
